#' Sunburst - a d3 implementation of sunburst chart in R.
#'
#'
#' @import htmlwidgets
#'
#' @export
sunburst <- function(src, width = NULL, height = NULL, elementId = NULL) {
...
sunburstOutput <- function(outputId, width = '100%', height = '400px'){
  htmlwidgets::shinyWidgetOutput(outputId, 'sunburst', width, height, package = 'sunburst')
}
